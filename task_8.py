...
print(a, b)
#Прибавляем ко второму числу, первое число
b += a
#Отнимаем от суммы двух чисел первое число и присваиваем к переменной a,
#тем самым меняя первое число, на второе
a = b - a
#Т.к. в переменной b, сумма двух чисел, отнимаем число из переменной a
b -= a
print(a, b)
